/* autogenerated by Processing revision 1283 on 2022-10-18 */
...
int hour,minute;
 ...
 public void setup() {
    ...
    box_color = new int[box_table.getRowCount()];
 ...
 public void draw() {
    ...
    minute = PApplet.parseInt(current_time-(floor(current_time/60)*60));
 ...
 public void button(int _textsize, int _color, int _width, int _height, int _rad,
 ...
 public void get_start_name(int _idx) { 
 ...
 public void get_end_name(int _idx) {
            ...
            if(floor(current_time/10)==timestamp[i] && timestamp[i]*10<current_time+10){
                ...
                pushMatrix();
                    ...
                    if(current_time-(timestamp[i]*10) < 6){
                        float box_height = density[i]*(30.0f/5.0f)*(current_time-(timestamp[i]*10));
                        box(box_size, box_size, box_height);
                    }else{
                        float box_height = density[i]*(30.0f/4.0f)*((10-(current_time-timestamp[i]*10)));
                        box(box_size, box_size, box_height);
                    }
                popMatrix();
            }
